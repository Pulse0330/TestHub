...
export default function ExmoLanding() {
	...
	return (
		<div className="min-h-screen bg-white dark:bg-[#030704] text-neutral-900 dark:text-neutral-100 font-sans antialiased transition-colors duration-300 overflow-x-hidden">
				...
				<div className="max-w-6xl mx-auto px-4 sm:px-8 lg:px-12 h-14 flex items-center justify-between">
					<div className="flex items-center flex-shrink-0">
						<Image
							...
							priority
						/>
						<span className="text-sm font-black tracking-[3px] uppercase bg-gradient-to-r from-teal-400 to-cyan-500 bg-clip-text text-transparent">
							EXMO
						</span>
					</div>
			...
			<div className="max-w-6xl mx-auto px-4 sm:px-8 lg:px-12 relative">
				...
				<section className="pt-16 sm:pt-24 pb-16 sm:pb-20 text-center">
					...
					<p className="text-sm sm:text-base text-neutral-500 dark:text-neutral-400 max-w-lg mx-auto mb-8 leading-relaxed font-light">
						Сурагч, оюутан, багш нарт зориулсан цахим шалгалт, дасгал ажил,
						сургалтын нэгдсэн платформ. Хаанаас ч нэвтэрч, мэдлэгээ хэмжээрэй.
					</p>
					...
					<div className="grid grid-cols-2 sm:grid-cols-4 bg-neutral-50 dark:bg-neutral-900/40 border border-neutral-200 dark:border-neutral-800 rounded-2xl overflow-hidden">
						{stats.map((s, i) => (
							...
							>
								...
								<div className="text-[10px] sm:text-xs text-neutral-400 mt-1 uppercase tracking-wide">
									{s.label}
								</div>
							</div>
						))}
				...
				<section
					id="features"
					className="py-12 sm:py-16 border-t border-neutral-200 dark:border-neutral-900"
				>
				...
				<section className="py-12 sm:py-16 border-t border-neutral-200 dark:border-neutral-900">
					...
					<div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
						{steps.map((s) => (
							<div
								key={s.num}
								className="relative bg-white dark:bg-[#050b06] border border-neutral-200 dark:border-neutral-800/60 rounded-2xl p-5 sm:p-6 overflow-hidden hover:border-emerald-500/25 transition-all"
							>
								<span className="absolute top-3 right-4 text-4xl font-black text-neutral-100 dark:text-neutral-800 select-none">
									{s.num}
								</span>
				...
				<footer className="py-6 sm:py-8 border-t border-neutral-200 dark:border-neutral-900 flex flex-col sm:flex-row items-center justify-between gap-3">
					...
					<span className="text-xs text-neutral-400 text-center">
						© 2026 EXMO. Бүх эрх хуулиар хамгаалагдсан.
					</span>
				</footer>
			</div>
			...
			>
				...
				>
					...
					<DialogDescription className="sr-only">
						Нэвтрэх нэр болон нууц үгээ оруулж нэвтэрнэ үү.
					</DialogDescription>
			...
			>
				<DialogContent
					className="p-0 border-0 bg-transparent shadow-none max-w-md w-full max-h-[90vh] overflow-y-auto [&>button:last-child]:hidden"
					onInteractOutside={(e) => e.preventDefault()}
				>
			...
			>
				...
				>
					...
					<DialogDescription className="sr-only">
						Бүртгэлтэй утасны дугаараа оруулж нууц үгээ сэргээнэ үү.
					</DialogDescription>
